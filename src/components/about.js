...
import emsad from "../images/emsad/emsad.jpg";

export default class About extends Component {
  render() {
    return (
      <section id='about' className='about observe'>
        <h2 className='section-title'>About me</h2>
        <div className='container'>
          <article className='profil-card'>
            <div className='profil-card__img'>
              <img src={emsad} alt='' />
              <ul className='profil-card__info-list'>
                <li>
                  <h4>Emsad Ahmetašević</h4>
                </li>
                <li>18.08.1987 Gradačac - BiH</li>
                <li>Tuzla - BiH</li>
                <li>emsad87@gmail.com</li>
              </ul>
            </div>
            ...
            <div className='profil-card__bio'>
              <h3>A bit about me...</h3>
              <p>Hi</p>
              <p>
                My name is Emsad, I am born in Gradačac, that's a small city in
                Bosnia &amp; Herzegovina. I like technology, sports, books,
                music, philosophy... Always looking to learn something new. Life
                circumstances and work made me move a lot, so I lived in
                Županja, Labin, Makarska in Croatien, Bremen in Germany, Banja
                Luka, Sarajevo, Tuzla (currently) in Bosnia. Moving around made
                me learn a lot, about people, cultures, traditions, and a lot
                more.
              </p>
              <p>
                For the last 14 years, I have worked in the field of customer
                support, maintenance, selling, and delivery. Worth mentioning is
                that it was for “Konica Minolta” and “Canon” partners. I used my
                free time to educate myself through online resources. So I have
                advanced knowledge of Html, CSS, javascript, and good knowledge
                of Github, sass, PHP, C#, MySQL, frameworks, etc… Good
                understanding of UI/UX, responsive design, semantic,
                accessibility, flexbox, grid, OOP, etc...
              </p>
              <p>
                I'm currently available for freelance projects or full-time
                work. If you're interested in working with me, please get in
                touch using one of the methods below. Or feel free to just say
                hi. I like that too.
              </p>
            </div>
            <div className='profil-card__hobbies'>
              <h3>Hobbies:</h3>
              <ul className='profil-card__hobbies-list'>
                <li>Music (DJ / Production)</li>
                <li>Sport (Calisthenics / Hiking)</li>
                <li>Reading (Psychology / Philosophy)</li>
                <li>Electronics (Arduino / Synths)</li>
                <li>Art (Painting / Audio &amp; Visual)</li>
                <li>DIY (Furniture / Mechanics)</li>
              </ul>
            </div>
          </article>
        </div>
        <div className='photoCredit'>
          <a href='https://unsplash.com/@fegiii'>
            Photo by: Felipe Giacometti / unsplash.com
          </a>
        </div>
      </section>
    );
