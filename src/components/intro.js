...
export default class Intro extends Component {
  render() {
    return (
      <header id='intro' className='intro observe'>
        <h1>Emsad Ahmetašević</h1>
        <h2>Front-end Developer / Service Technician</h2>
        <p>
          14+ years experience in customer support, maintenance, selling, and
          delivery.
        </p>
        <p>Good skills working with modern software and technology.</p>
        <p>Advanced knowledge of Html, CSS, javascript,</p>
        <p>Basic knowledge of PHP, Mysql, C#, etc...</p>
        <p>
          I am a positive, creative and fun person seeking more knowledge and
          opportunities to improve and show my best.
        </p>
          ...
          <ul className='social-icons__list'>
            ...
            <li className='social-icons__list-item'>
              <a
                ...
                title='Email'
              >
                <svg viewBox='0 0 309 229' xmlns='http://www.w3.org/2000/svg'>
        ...
        <div className='photoCredit'>
          <a href='https://unsplash.com/@grakozy'>
